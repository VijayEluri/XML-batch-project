...
public class PhoneField extends CharField {
	private static Log log = LogFactory.getLog(PhoneField.class);	
	Select select = null;
	...
	public String format(Object v) throws XMLBuildException {
		...
		if (v == null) {
			...
			returnValue = returnValue.replaceAll("\\D", ""); //remove all non-digits
